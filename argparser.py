...
def get_argparser():
    ...
    ### xjw changed(for method arg) ###
    parser.add_argument("--weight_fusion", default=False, action="store_true")
    parser.add_argument("--fix_pre_cls", default=False, action="store_true")
    parser.add_argument('--momentum_proto_cls', default=False, action="store_true")
    parser.add_argument('--cls_contrastive', default=False, action="store_true")
    parser.add_argument('--threshold_choice', default=False, action="store_true")
    parser.add_argument('--fix_weight', default=1, type=float)
